...
static const QString initmsg = "EVMp";
 ...
 * PROTOCOL
 *
 * EVMp_CONNECT_<username.length>_<username> - connection
 * EVMp_ALIVE_<username.length>_<username> - notification of presence
 * EVMp_SENDMSG_<message.length>_<message> - send message
 * EVMp_CAL - call
 *
